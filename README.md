...
1. `Halcyon.app` を `/Applications` に移動して起動
2. メニューバーのアイコンをクリックしてポップオーバーを開く
3. 各ステップの待機時間を設定してスイッチをONに
4. 離席するだけ — Halcyon が自動でスリープの流れを制御します
...
- **ステップごとの個別設定** — 各アクションのON/OFFと待機時間（1〜120分）を自由に設定
- **ワンクリック ON/OFF** — メニューバーのトグルで即座に有効/無効を切り替え
